...
import { N as NUXT_CONFIG } from './server.mjs';
...
const _imports_0$1 = joinURL(NUXT_BASE$1, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/txo_logo.d1de97a4.svg".replace("/__NUXT_BASE__", ""));
const _sfc_main$5 = {
  name: "TheHeader",
  mount() {
  },
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "hero" }, _attrs))}><div class="hero-text-container"><div class="row hero-headline"><div class="col-xs-12 col-md-11"><h1>We\u2019re hands-on and committed to evolving your business to strive for better.</h1></div></div><div class="row hero-paragraph"><div class="col-xs-12 col-md-6 col-md-offset-5"><h2>Our Offering</h2><p>We provide physical, pragmatic and personal business guidance. Success is never static. Neither are we. We\u2019ll be your business partners for positive change. </p></div></div></div></section>`);
}
...
const _sfc_main$3 = {
  ...
  mounted() {
    ...
    function setDetailsHeight(selector3, wrapper = document) {
      ...
      const details = wrapper.querySelectorAll(selector3);
      const RO = new ResizeObserver((entries) => {
        return entries.forEach((entry2) => {
          const detail = entry2.target;
          const width = parseInt(detail.dataset.width, 10);
          if (width !== entry2.contentRect.width) {
    ...
    document.querySelectorAll("details").forEach((details) => {
      details.addEventListener("toggle", (event) => {
        const expandedHeight = getComputedStyle(document.querySelector("details")).getPropertyValue("--expanded");
        if (details.open) {
        ...
        serverRenderer.exports.ssrRenderList($data.slides, (slide) => {
          _push2(serverRenderer.exports.ssrRenderComponent(_component_swiper_slide, {
            ...
            default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<figure${_scopeId2}><img${serverRenderer.exports.ssrRenderAttr("src", slide.image)}${serverRenderer.exports.ssrRenderAttr("alt", slide.name)}${_scopeId2}><figcaption class="${serverRenderer.exports.ssrRenderClass([slide.moreInfo ? "info" : "no-info"])}"${_scopeId2}><div class="row"${_scopeId2}><div class="col-xs-12 col-md-6"${_scopeId2}> Name: ${serverRenderer.exports.ssrInterpolate(slide.name)}</div><div class="col-xs-12 col-md-6"${_scopeId2}> Availability: [${serverRenderer.exports.ssrInterpolate(slide.availability)}] </div></div>`);
                if (slide.moreInfo === 1) {
                  _push3(`<details${_scopeId2}><div class="row"${_scopeId2}><div class="col-xs-12 col-md-6"${_scopeId2}> Location: [${serverRenderer.exports.ssrInterpolate(slide.location)}] </div><div class="col-xs-12 col-md-6"${_scopeId2}> Size: [${serverRenderer.exports.ssrInterpolate(slide.size)}] sqft </div></div><div class="row"${_scopeId2}><div class="col-xs-12 col-md-6 col-md-offset-6"${_scopeId2}><p${_scopeId2}>${serverRenderer.exports.ssrInterpolate(slide.description)}</p></div></div><summary${_scopeId2}><div class="button open"${_scopeId2}>Read More</div><div class="button close"${_scopeId2}>Hide Text</div></summary></details>`);
                } else {
                  _push3(`<!---->`);
                }
                _push3(`</figcaption></figure>`);
              } else {
                return [
                  vue_cjs_prod.createVNode("figure", null, [
                    ...
                    vue_cjs_prod.createVNode("figcaption", {
                      ...
                      slide.moreInfo === 1 ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("details", { key: 0 }, [
                        vue_cjs_prod.createVNode("div", { class: "row" }, [
...
const _imports_0 = joinURL(NUXT_BASE, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/thirdway.28d78779.svg".replace("/__NUXT_BASE__", ""));
const _sfc_main$1 = {
  name: "TheFooter"
};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<footer${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div class="row"><div class="col-xs-12 col-md-6"><a href="#"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} class="logo" alt="Thirdway"></a></div><nav class="col-xs-12 col-md-6"><ul><li><a href="#">Terms and Conditions</a></li><li><a href="#">Privacy Policy</a></li><li><a href="#">Cookie Policy</a></li><li><a href="#">Accessibility</a></li></ul></nav></div></footer>`);
}
...
const _sfc_main = {
  ...
  mounted() {
    ...
    function smoothScroll(content, viewport, smoothness) {
      ...
      gsapWithCSS.set(viewport || content.parentNode, { overflow: "hidden", position: "fixed", height: "100%", width: "100%", top: 0, left: 0, right: 0, bottom: 0 });
  ...
  methods: {
    resizeHandler(e) {
      ...
      var headerHeight = window.getComputedStyle(document.documentElement).getPropertyValue("--header-height");
      var headerHeightOffset = Number(headerHeight.replace("px", ""));
      let logoTimeline = gsapWithCSS.timeline({
        scrollTrigger: {
          invalidateOnRefresh: true,
          markers: false,
          trigger: "header",
      ...
      logoTimeline.clear().fromTo(".logo-container", {
        scale: 3,
        opacity: 1,
        ...
        y: 0,
        scale: 1
      }, "0").fromTo("header aside", { opacity: 0 }, { opacity: 1 }, "0").fromTo("section.hero", { opacity: 0 }, { opacity: 1 }, "0").fromTo("#stay-updated", { opacity: 0 }, { opacity: 1 }, "0");
      let prevButton = document.querySelector(".swiper-button-prev");
      let nextButton = document.querySelector(".swiper-button-next");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div><div id="cursor-swiper"><div id="cursor-text"></div></div><a href="#subscribe" id="stay-updated" class="anchor">Stay Updated</a><!--]-->`);
}
